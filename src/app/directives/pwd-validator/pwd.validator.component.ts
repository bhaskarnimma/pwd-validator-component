...
@Component({
  ...
  <div class="marg">
    <div>
      ...
      <div [ngStyle]="{'color' : !doesLowercaseCharacterExist ? 'red': 'green'}">Include at least one lowercase letter</div>
      <div [ngStyle]="{'color' : !doesUppercaseCharacterExist ? 'red': 'green'}">Include atleast one uppercase letter</div>
      <div [ngStyle]="{'color' : !doesNumberExist ? 'red': 'green'}">Include atleast one number</div>
    </div>
  </div>  
  `,
